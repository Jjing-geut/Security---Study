...
[ 1개월차: 기초 인프라 및 언어 적응기 ]
목표: 코드 독해력 확보 및 터미널 환경 익숙해지기
...
파이썬 (1.5H): 제어문/함수 정복 후 구글링 없이 가위바위보 게임 구현 (혼공파 활용)

리눅스 (1H): OverTheWire Bandit 1~15단계 (명령어 grep, find, awk 숙달)

[ 2개월차: 웹 취약점 원리 및 도구 숙달 ]
목표: 주요 취약점 메커니즘 이해 및 드림핵 입문
...
[ 3개월차: 실전 워게임 및 기술 문서화 ]
목표: 독립적인 문제 해결 및 모의해킹 보고서 작성 기초 확보
...
병행의 원칙: 정보보안기사 결과와 상관없이 이 루틴을 유지하라. 실습이 곧 최고의 시험 공부다.
