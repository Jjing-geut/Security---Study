...
<p>cf) CSS 중요내용<br>
id (#) / class (.) : 특정 HTML 요소를 지칭할 때 사용 (JS와 연동됨)<br>
display: none;	: 화면에는 안 보이지만 HTML 소스에는 존재하는 요소 찾기<br>
z-index	 : 투명한 레이어를 씌워 클릭을 유도할 때 (낚시 사이트 제작)<br>
...
<br>
<br>
<p style="margin-top:10px;">⚠️ T의 행동 강령 (필독)<br>
